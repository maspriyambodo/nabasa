                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="<?= base_url('Admin/Kodepos'); ?>">Master Kodepos</a></li>
                                            <li><a href=<?= base_url('Admin/Sales'); ?>>Master Sales</a></li>
                                            <li><a href=<?= base_url('Admin/Salesarea'); ?>>Master Sales Area</a></li>
                                            <li><a href=<?= base_url('Admin/Nasabah'); ?>>Master Nasabah</a></li>
                                            <li><a href=<?= base_url('Admin/KodeInteraksi'); ?>>Master Kode Interaksi</a></li>
                                        </ul>
                                    </li>
