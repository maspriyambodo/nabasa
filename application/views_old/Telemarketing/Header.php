                                ...
                                <ul class="nav side-menu">
                                    <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="<?= base_url('Telemarketing/Dashboard/index'); ?>">Rencana Telemarketing</a></li>
                                            <li><a href="<?= base_url('Telemarketing/Dashboard/Hasilinteraksi'); ?>">Hasil Interaksi</a></li>
                                            <li><a href="<?= base_url('Telemarketing/Dashboard/OTS'); ?>">Interaksi non database</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class> <a href=javascript: class="text-uppercase user-profile dropdown-toggle" data-toggle=dropdown aria-expanded=false> <img src="<?= base_url($this->session->userdata('gambar')); ?>"><?= $this->session->userdata('nama'); ?> <span class="fa fa-angle-down"></span> </a>
                                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                                        <li><a href="<?= base_url('Telemarketing/Dashboard/Logout'); ?>"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </nav>
