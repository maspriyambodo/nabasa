<div class="x_panel">
    ...
    <div class="x_content">
        <div class="text-center">
            <a href="<?= base_url('Marketing/Marketing/index'); ?>" class="btn btn-danger text-uppercase">back</a>
        </div>
        ...
        <!--                                    <input type="checkbox" value="<?= $Value->NOTAS ?>" name="checkbtn<?= $Value->NOTAS ?>">-->
                                    <a href="<?= base_url('Marketing/Dashboard/Simpanrencana/' . $Value->NOTAS . ''); ?>" target="_new" onclick="refreshbtn()" class="btn btn-success text-uppercase btn-xs">pilih</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
